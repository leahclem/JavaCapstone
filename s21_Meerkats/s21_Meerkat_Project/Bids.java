...
/**
 * 
 * This class controls all functionality surround Auctions. As far as storing
 * history, backlogg, and even processing bid queries and updating the current
 * winner and other pieces of data.
 */
public class Bids {
	// fields
	/**
	...
	/**
	 * The highest bid of the current winner, there cannot be a new winner till
	 * someone bids higher than this number
	 */
	private double maxBid;
	/**
	 * The bare minimum someone is allowed to bid above the current bid.
	 */
	...
	/**
	 * Determines if the winner has paid for the puppy, this can only change when
	 * the Auction
	 */
	private boolean paidFor = false;// will be used for checkpoint 6
	/**
	 * The queue used to contain the backlogged data, this data can only be
	 * retrieved by an admin.
	 */
	private Queue<String> backlogg;// this is where backlogg is stored for checkpoint 2
	/**
	 * The queue used to contain the Auction history, can be viewed by an admin.
	 */
	...
	/**
	 * Constructor used to load in Database auctions, that are already in progress
	 * 
	 * @param pup
	 *            - the puppy finding a new home
	 * @param end
	 ...
	 * @param maxBid
	 *            - the current high bid on the Auction
	 * @param winner
	 *            - the current winner on the Auction
	 * @param active
	 *            - the current status of the Auction
	 * @param paidFor
	 *            - determines if the puppy has been paid for yet
	 */
	public Bids(Puppies pup, LocalDateTime end, LocalDateTime start, double currentBid, double maxBid, User winner,
			boolean active, boolean paidFor)// will be to bring in bids already made before
	{
		this.pup = pup;
		this.endBy = end;
		this.startBy = start;
	...
	/**
	 * The regular Auction constructor, used for creating a new Auction
	 * 
	 * @param pup
	 *            - the puppy finding a new home
	 * @param end
	...
	/**
	 * The function adds Auction history for the first time to an Auction
	 * 
	 * @param u
	 *            - the user who bidded
	 * @param newBid
...
//			System.out.println("INSERT INTO bidhistory (\'"+pup.getName() + "\', \'" + bh + "\')");
	...
	/**
	 * Adds to Auction bid history, whenever someone contributes to a bid
	 * 
	 * @param u
	...
	/**
	 * Adds to Auction bid history, when someone doesn't bid enough money
	 * 
	 * @param u
	 *            - the user who did not bid enough
	 * @param newBid
	 *            - the amount they bidded
	 */
	 ...
	 * 
	 * @param maxBid
	 *            - the highest bid that belongs to the winner
	 */
	 ...
	 * 
	 * @return - the base increments above the current bid that a customer must bid
	 */
	 ...
	 * 
	 * @param increment
	 *            - the value it will be changed to
	 */
	 ...
	 * 
	 * @param paidFor
	 *            - the value for it to be changed to
	 */
	 ...
	 * 
	 * @param backlogg
	 *            - the value for it to be changed too
	 */
