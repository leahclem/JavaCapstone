...
/**
 * 
 * The AuctionHouse class contains all bids, users, and puppies.
 * It is used to keep track of the active bids, users' bids, bidding times, and close bids once the time is up. 
 * This class can also be used to access closed bids and their winners once the auction is over
 *
 */
public class AuctionHouse {
	...
	/**
	 * Full AuctionHouse constructor - used to access status of the AuctionHouse plus all bids, puppies, and users. 
	 * @param open - if the auction house is open or closed
	 * @param allBids - all users' bids 
	 * @param allPups - all puppies
	...
	/**
	 * checkTime method - checks if a bid's end time has been reached based on local date and time. 
	 * Establishes the winner when the bid ends and updates the bids database. 
	 */
	...
	/**
	 * closedBids method - if a bid is past the ending date this method prints all of the closed bids.
	 */
	 ...
	 * @param allBids ArrayList of Bids objects
	 */
	 ...
	 * @param allPups ArrayList of Puppies objects 
	 */
	 ...
	 * @param allUsers ArrayList of Users objects 
	 */
